...
const Stoplight = require('@trufflesuite/web3-provider-engine/util/stoplight.js')
const cacheUtils = require('@trufflesuite/web3-provider-engine/util/rpc-cache-utils.js')
const createPayload = require('@trufflesuite/web3-provider-engine/util/create-payload.js')
const noop = function(){}
